...
from bot.model_definitions import MoodCategory

dir = path.dirname(__file__)


def patterns_for_mood(category: MoodCategory) -> Iterator[str]:
    """
    ...
    if not p.is_file():
        raise FileNotFoundError(
            'No pattern definition file found for this mood {}'.format(category))
